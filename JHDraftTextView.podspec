#
#  Be sure to run `pod spec lint JHDraftTextView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "徐嘉宏"
  s.authors            = { "徐嘉宏" => "xjh_28@163.com" }
  ...
  s.source_files  = "DraftDemo/JHDraftTextView/*"
